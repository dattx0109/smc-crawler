...
<head>
    ...
    <!--bootstrap-toggle-->
    <link href="{{asset('css/plugins/bootstrap-toggle/bootstrap-toggle.min.css')}}" rel="stylesheet">
        ...
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element"> <span>
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="clear"> <span class="block m-t-xs"> <strong class="font-bold">{{session('user')->name}}</strong>
                             </span> <span class="text-muted text-xs block">{{session('user')->email}} <b class="caret"></b></span> </span> </a>
                ...
                <li class="{{ request()->is('/') ? 'active' : '' }}">
                    <a href="/"><i class="fa fa-th-large"></i> <span class="nav-label">Danh sách website</span></a>

                </li>
                <li class="{{ request()->is('domain-job') ? 'active' : '' }}">
                    <a href="/domain-job"><i class="fa fa-th-large"></i> <span class="nav-label">Danh sách công việc</span></a>

                </li>
                <!-- comment tam thoi khong hien menu trai
...
{{--                    </form>--}}
                ...
                <ul class="nav navbar-top-links navbar-right">
                    <li>
                        <span class="m-r-sm text-muted welcome-message">Welcome to SAMACOM Crawler</span>
                    </li>
{{--                    <li class="dropdown">--}}
...
{{--                    </li>--}}
                    <li class="dropdown">
                        <a class="dropdown-toggle count-info" data-toggle="dropdown" href="#">
                            <i class="fa fa-bell"></i>  <span class="label label-primary" id="notification_total"></span>
                        </a>
...
<!--bootstrap-toggle-->
<script src="{{asset('js/plugins/bootstrap-toggle/bootstrap-toggle.min.js')}}"></script>
{{--<!-- Sparkline -->--}}
...
<script src="{{asset('js-service/notification.js')}}"></script>
